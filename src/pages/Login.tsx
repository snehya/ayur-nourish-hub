...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      {/* Background elements */}
      <div className="absolute top-20 left-20 w-72 h-72 rounded-full healing-gradient opacity-10 blur-3xl"></div>
      <div className="absolute bottom-20 right-20 w-96 h-96 rounded-full earth-gradient opacity-10 blur-3xl"></div>
